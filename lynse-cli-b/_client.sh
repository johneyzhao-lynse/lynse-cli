...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "claimByActivityId[]" \
            "list4[]"             "chatStream[]" \
            "listChatFiles[]"             "bindVocabulary[]" \
            "getBoundVocabulary[]" \
            "listEnabledVocabularies[]" \
            "unbindVocabulary[]"             "auditText[]"             "list3[]"             "getPoolStatus[]"             "changeTeam[]" \
            "current[]" \
            "detail[]" \
            "edit2[]" \
            "edit3[]" \
            ...
            "unbind[]" \
            "update[]" \
            "updateConnectTime[]"             "addEvaluation[]" \
            "changeFolder[]" \
            "cleanBin[]" \
            "cleanBinAll[]" \
            "countByCategory[]" \
            ...
            "listMyTeam[]" \
            "recharge[]" \
            "removeTeamMember[]"             "editTeamFile[]" \
            "getFileInfo[]" \
            "listTeamFile[]" \
            "moveOrCopy[]" \
            "removeTeamFile[]"             "createInvitation[]" \
            "handleInvite[]" \
            "listMyInvitation[]"             "getLatestSpeakerNames[]" \
